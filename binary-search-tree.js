...
class Tree {
    ...
    find(value, root = this.root) {
        ...
        if (root.data > value) {
            ...
            return this.find(value, rightPart);
        }
    ...
    delete(value, root = this.root) {
        ...
        if (root.data > value) {
            ...
            root.rightPart = this.delete(value, rightPart);
        } else {
            if (root.leftPart == null) {
    ...
    rebalance() {
        ...
        let rebalancedNewTreeAray = [];
        rebalancedNewTreeAray = this.traverse(this.root, rebalancedNewTreeAray);

        let balancedTree = new Tree(rebalancedNewTreeAray);
